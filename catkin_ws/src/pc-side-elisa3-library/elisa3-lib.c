...
void transferData() {
    ...
    if((int)((unsigned char)RX_buffer[0])<=2) { // if something goes wrong skip the data
        ...
        //printf("Robot %d, type message %d \n", (currPacketId*4+0), (int)((unsigned char)RX_buffer[0]));
        ...
        switch((int)((unsigned char)RX_buffer[0])) {
            ...
            case 4:
                ...
                //printf("ground %d:: [%d, %d] \n", (currPacketId*4+0), groundValue[currPacketId*4+0][0], groundValue[currPacketId*4+0][0]);
                break;
            ...
            case 7:
                ...
                //printf("Pos %d:: [%d, %d] \n",currPacketId*4+0, robXPos[currPacketId*4+0], robYPos[currPacketId*4+0]);
                break;
        }
    }
    ...
    if((int)((unsigned char)RX_buffer[16])<=2) { // if something goes wrong skip the data
        ...
        //printf("Robot %d, type message %d \n", (currPacketId*4+1), (int)((unsigned char)RX_buffer[16]));
        switch((int)((unsigned char)RX_buffer[16])) {
            ...
            case 7:
                ...
                //printf("Pos %d:: [%d, %d] \n", currPacketId*4+1, robXPos[currPacketId*4+1], robYPos[currPacketId*4+1]);
                break;
        }
    }
    ...
    if((int)((unsigned char)RX_buffer[32])<=2) { // if something goes wrong skip the data
        ...
        //printf("Robot %d, type message %d \n", (currPacketId*4+2), (int)((unsigned char)RX_buffer[32]));
        switch((int)((unsigned char)RX_buffer[32])) {
            ...
            case 7:
                ...
                printf("Pos %d:: [%d, %d] \n", currPacketId*4+2, robXPos[currPacketId*4+2], robYPos[currPacketId*4+2]);
                break;
        }
    }
    ...
    if((int)((unsigned char)RX_buffer[48])<=2) { // if something goes wrong skip the data
        ...
        //printf("Robot %d, type message %d \n", (currPacketId*4+3), (int)((unsigned char)RX_buffer[48]));
        switch((int)((unsigned char)RX_buffer[48])) {
            ...
            case 7:
                ...
                printf("Pos %d:: [%d, %d] \n", currPacketId*4+3,robXPos[currPacketId*4+3], robYPos[currPacketId*4+3]);
                break;
        }
    }
